...
class ReceiverWriteMessage extends Thread {
    ...
    public ReceiverWriteMessage(PrintWriter out, Scanner sc, String name) {
        ReceiverWriteMessage.out = out;
        ReceiverWriteMessage.sc = sc;
        ReceiverWriteMessage.name = name;
    }
...
class ReceiverGetMessage extends Thread {
    ...
    public ReceiverGetMessage(BufferedReader in, String name) {
        ReceiverGetMessage.in = in;
        ReceiverGetMessage.myName = name;
    }
...
public class Receiver {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ReceiverWriteMessage writeMessage = new ReceiverWriteMessage(out, sc, name);
        writeMessage.start();
        getMessage.start();
    }
